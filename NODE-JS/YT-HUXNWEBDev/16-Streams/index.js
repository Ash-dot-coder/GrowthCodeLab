...
They provide a way to work with large amounts of data, 
such as reading a large file or receiving a large amount of data over a network connection,
without loading the entire dataset into memory. Streams can be readable, writable, or both,
and can be used to pipe data between different sources and destinations.
 */
